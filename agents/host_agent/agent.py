...
def create_agent() -> SequentialAgent:
    """Create the sequential A2A customer-support orchestrator."""
    logger.info("Creating remote Customer Data Agent connection")
    ...
    logger.info("Creating remote Support Agent connection")
    ...
    return SequentialAgent(
        ...
        description=(
            "Coordinates customer data lookup followed by support guidance"
        ),
